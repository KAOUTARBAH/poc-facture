...
//	}
	...
	void saveInvioce() {
       ...
       System.out.println(facture.getLibelle());
	...
	void updateInvioce() {
		 // Given
        Facture updatedFacture = this.buildTestingFacture();
        //facture.setId(sequenceGeneratorService.generateSequence(facture.SEQUENCE_NAME));
        updatedFacture.setId(2L);
        updatedFacture.setLibelle("Machaine A CAFE_UPDATE_SERVICE");
		updatedFacture.setClient("CARFFEUR_UPFATE_SERVICE");
		updatedFacture.setMontant(900F);
       
        // When 
        this.factureService.updateFacture(updatedFacture);
       
        // Then      
        verify(this.factureRepository).save(updatedFacture);
      ...
      void deleteByIdFacture() {
          // When
          this.factureService.deleteFacture(1L);
          // Then
          verify(this.factureRepository).deleteById(1L);
      }
	 ...
	 private List<Facture> buildTestingFactures() {
		 ...
		 facture.setId(2L);
		 facture.setLibelle("FIRST_NAME2");
		 facture.setClient("LAST_NAME2");
